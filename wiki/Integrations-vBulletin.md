...
This page provides instructions for vBulletin forum hosts to integrate their forums with Discord RSS.
...
- Monitor the integration to ensure that updates from your vBulletin forum continue to be posted to Discord RSS without issues.
- If you encounter any problems, check the vBulletin logs and Discord RSS logs for troubleshooting information.


## Host Template

This template provides a general structure for integrating a vBulletin forum with the Discord RSS service. It may need to be adjusted based on your specific forum setup and requirements.
